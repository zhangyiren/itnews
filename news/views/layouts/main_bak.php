                            ...
                            <form id="front_search_form" method="post" action="/zms/news/web/index.php?r=site/index">
                                <div class="panel-body text-center">                         
                                    <div class="input-group">
                                        <input name="_csrf-frontend" id="_csrf-frontend" type="hidden" value="{$csrf_token}">
...
EOF;
                ...
                if($action_id=='signup' || $action_id=='login' || $action_id=='error'){
                }else{
                    echo $myblock;
                }
            ?>
...
<footer class="footer">
    <div class="container">
        <p class="text-center">&copy; Powered by zhangyiren <?= date('Y') ?></p>
    </div>
</footer>
